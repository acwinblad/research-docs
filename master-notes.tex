...
%\input{./notes/solving-BdG-triangular-lattice.tex}

%\input{./notes/majorana-fermions-tunable-device.tex}

%\input{./notes/edge-state.tex}

%\input{./notes/numerical-rashba-triangular-lattice.tex}
