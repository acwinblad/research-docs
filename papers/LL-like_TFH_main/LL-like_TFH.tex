...
\begin{abstract}
%Motivated by the recent discovery of Floquet systems, we demonstrate that these systems produce an unconventional form of quantized Landau Level-like spectrum and the corresponding quantum Hall effect without need of an external perpendicular magnetic field.
%The unconventional quantization in Floquet systems is caused by employing three linearly polarized laser lights in the off-resonant regime with two lights creating a spatially inhomogeneous standing wave.
...
%\Blue{We elucidate the origin of the quantized Hall conductance and the Berry phase(what?) by using the Floquet theory--adiabatic trajectory of wave packets.}
...
\emph{Floquet Landau level-like bands in Dirac systems.---} In this section we demonstrate a Dirac system in the presence of a standing, non-uniform, circularly polarized light becomes an effective Dirac Hamiltonian with a magnetic field composed of the electric field component of light.
