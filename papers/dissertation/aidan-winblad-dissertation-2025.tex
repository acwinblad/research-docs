...
\title{Emergent Topological Phenomena in Low-Dimensional Systems Induced by Gauge Potentials}
...
\mycopyright{%
Copyright by Aidan Winblad 2025 \\
All Rights Reserved
}
...
\acknowledgements{%
  I would like to acknowledge my advisor Dr. Hua Chen for mentoring me, his insight, and his patience for all these years.
  I am thankful to my committee members Dr. Martin Gelfand, Dr. Richard Eykholt, and Dr. Olivier Pinaud.
  I'd like to thank my Chris Ard and Dr. Muhammad Tahir for insightful discussions.
  My friends and family who helped make this journey possible and enjoyable.
  Finally, the CSU Mental Health Services for helping me along the way to be more productive and successful.
}
...
\input{./ch-01/effective-p-wave.tex}
...
\input{./ch-app/effective-p-wave-derivation.tex}
