...
\begin{figure}[ht]
  \hspace{10pt}
  \subfloat[]{\includegraphics[width=0.53\textwidth]{topological-phase-diagram-1pi6-n-1.pdf}} \\
  \vspace{-15pt}
  \subfloat[]{\includegraphics[width=0.50\textwidth]{spectral-flow-nr-50-w-1-mu-1_6.pdf}}
...
\begin{figure*}[ht]
  \hspace{-45pt}
  \subfloat[]{\includegraphics[height=150pt]{spectral-flow-rotation-constant-vector-nr-50-w-1-mu-1_6.pdf}} \\
  \subfloat[]{\includegraphics[height=125pt]{GS-T-Square.pdf}}\hspace{-20pt}
  \subfloat[]{\includegraphics[height=125pt]{GS-T-Circle.pdf}}\hspace{-20pt}
  \subfloat[]{\includegraphics[height=127.5pt]{GS-T-Diamond.pdf}}
