\subsection{Tight-binding model 2DEG}
...
\begin{align}
  \ham_{jj,n}(k) &= -\dfrac{h}{2\pi} \int_0^{2\pi} \left( e^{i \phi_0 \cos(Kx_j) \cos \tau - ika - in\tau} + e^{-i \phi_0 \cos(Kx_j) \cos \tau + ika - in\tau} \right) d\tau \nonumber \\
    ...
    &= -h J_n(\phi_0 \cos(Kx_j)) \cos \left( ka -in\pi/2 \right)
\end{align}
and
