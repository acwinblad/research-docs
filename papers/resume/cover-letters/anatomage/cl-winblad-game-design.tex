...
% Company information
\newcommand{\position}{Game Designer} % The company (e.g. "Microsoft Corporation")
\newcommand{\company}{Anatomage} % The company (e.g. "Microsoft Corporation")
\newcommand{\street}{} % The company's street address (e.g. "1 Microsoft Way")
\newcommand{\city}{Santa Clara} % The company's city (e.g. "Redmond")
