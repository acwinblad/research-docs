...
% Company information
\newcommand{\position}{Simulation Software Developer} % The company (e.g. "Microsoft Corporation")
\newcommand{\company}{Apple} % The company (e.g. "Microsoft Corporation")
\newcommand{\street}{} % The company's street address (e.g. "1 Microsoft Way")
\newcommand{\city}{San Diego} % The company's city (e.g. "Redmond")
