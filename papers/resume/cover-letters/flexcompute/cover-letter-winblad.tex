...
% Company information
\newcommand{\position}{Rising Stars in Scientific Computing} % The company (e.g. "Microsoft Corporation")
\newcommand{\company}{Flexcompute} % The company (e.g. "Microsoft Corporation")
\newcommand{\street}{} % The company's street address (e.g. "1 Microsoft Way")
\newcommand{\city}{Boston} % The company's city (e.g. "Redmond")
