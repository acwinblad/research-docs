...
% Company information
\newcommand{\position}{Computational Physics Software Engineer} % The company (e.g. "Microsoft Corporation")
\newcommand{\company}{PassiveLogic} % The company (e.g. "Microsoft Corporation")
\newcommand{\street}{} % The company's street address (e.g. "1 Microsoft Way")
\newcommand{\city}{Holladay} % The company's city (e.g. "Redmond")
\newcommand{\state}{UT} % The company's state prefix (e.g. "WA")
