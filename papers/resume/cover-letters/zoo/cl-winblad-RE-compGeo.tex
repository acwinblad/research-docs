...
% Company information
\newcommand{\position}{Research Engineer, Computational Geometry} % The company (e.g. "Microsoft Corporation")
\newcommand{\company}{Zoo} % The company (e.g. "Microsoft Corporation")
\newcommand{\street}{} % The company's street address (e.g. "1 Microsoft Way")
\newcommand{\city}{Los Angeles} % The company's city (e.g. "Redmond")
