...
\begin{document}
    ...
    \begin{header}
        ...
        \mbox{1007 Butte Pass Dr, Fort Collins, CO}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{DoB: 02/24/1992}%
    ...
    \section{Education}
        ...
        \textbf{B.S. in Mathematics and B.S. in Physics}, \textit{Fort Hays State University}, \text{Hays, KS} \end{twocolentry}
        ...
        \textbf{M.S. in Physics}, \textit{Colorado State University}, \text{Fort Collins, CO} \end{twocolentry}
        ...
        \textbf{Ph.D. in Physics}, \textit{Colorado State University}, \text{Fort Collins, CO} \end{twocolentry}
