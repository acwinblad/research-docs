...
\begin{figure}[ht]
  \hspace{6pt}
  \subfloat[]{\includegraphics[width=0.316\textwidth]{./figures/topological-phase-diagram-1pi6-n-1.pdf}} \\
  \vspace{-15pt}
  \subfloat[]{\includegraphics[width=0.30\textwidth]{./figures/spectral-flow-nr-50-w-1-mu-1_6.pdf}}
...
\begin{figure*}[ht]
  \subfloat[]{\includegraphics[height=105pt]{./figures/spectral-flow-rotation-constant-vector-nr-50-w-1-mu-1_6.pdf}}
  \subfloat[]{\includegraphics[height=100pt]{./figures/GS-T-Square.pdf}}\hspace{-20pt}
  \subfloat[]{\includegraphics[height=100pt]{./figures/GS-T-Circle.pdf}}\hspace{-20pt}
  \subfloat[]{\includegraphics[height=102pt]{./figures/GS-T-Diamond.pdf}}
...
\begin{figure}[ht]
  \begin{tikzpicture}
    ...
    {\includegraphics[width=0.45\textwidth]{./figures/4-mf-swap-2-3.pdf}};

    \node[inner sep=0pt] (a) at (-4,1.75) {(a)};
    \node[inner sep=0pt] (b) at (0.1,1.75) {(b)};
    \node[inner sep=0pt] (c) at (-4,-.25) {(c)};
    \node[inner sep=0pt] (d) at (0.1,-.25) {(d)};

    \node[inner sep=0pt] (gamma1) at (-3.4,0.25) {$\gamma_1$};
    \node[inner sep=0pt] (gamma2) at (-2.4,0.25) {$\gamma_2$};
    \node[inner sep=0pt] (gamma3) at (-1.4,0.25) {$\gamma_3$};
    \node[inner sep=0pt] (gamma4) at (-0.4,0.25) {$\gamma_4$};

    \node[inner sep=0pt] (gamma1) at (0.65,0.25) {$\gamma_1$};
    \node[inner sep=0pt] (gamma2) at (1.65,0.25) {$\gamma_2$};
    \node[inner sep=0pt] (gamma3) at (2.4,1.4) {$\gamma_3$};
    \node[inner sep=0pt] (gamma4) at (3.65,0.25) {$\gamma_4$};

    \node[inner sep=0pt] (gamma1) at (-3.4,-1.75) {$\gamma_1$};
    \node[inner sep=0pt] (gamma3) at (-1.63,-0.60) {$\gamma_3$};
    \node[inner sep=0pt] (gamma2) at (-1.4,-1.75) {$\gamma_2$};
    \node[inner sep=0pt] (gamma4) at (-0.4,-1.75) {$\gamma_4$};

    \node[inner sep=0pt] (gamma1) at (0.65,-1.75) {$\gamma_1$};
    \node[inner sep=0pt] (gamma3) at (1.65,-1.75) {$\gamma_3$};
    \node[inner sep=0pt] (gamma2) at (2.65,-1.75) {$\gamma_2$};
    \node[inner sep=0pt] (gamma4) at (3.65,-1.75) {$\gamma_4$};
