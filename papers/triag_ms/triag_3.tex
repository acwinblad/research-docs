...
\begin{figure}[ht]
  \subfloat[]{\includegraphics[width=2.5 in]{3site.png}}\\
  \subfloat[]{\includegraphics[width=2.5 in]{finitewidth.png}}
...
\end{eqnarray}
where $e>0$ is the absolute value of the electron charge. Below we use the natural units $e=\hbar=1$. To get the conditions for having MZM in this model we rewrite $\mathcal{H}$ in the Majorana fermion basis $a_{j} = c_j + c^\dag_j$, $b_j = \frac{1}{i}(c_j - c^\dag_j)$ \cite{supp}:
...
\begin{figure}[ht]
  \subfloat[\label{subfig: majorana-number-5pi6ths}]{%
    \includegraphics[width=0.3\textwidth]{pd.pdf}%
  }\\
    \subfloat[\label{subfig: majorana-number-5pi6ths}]{%
    \includegraphics[width=0.35\textwidth]{./figures/spectral-flow-n-100-w-3-mu-0_0.pdf}%
  }
...
%  }\hfill
  \caption{Topological phase diagrams for a $W=1$ triangular chain with its Hamiltonian given by Eq.~\eqref{eq:Hribbon}. (a) Phase diagram for infinite chains overlapped. (b) Spectral flow for a finite triangle (length = 50, $W=1$, $\mu = 1.6$, range of $A$: 0 to $4\pi/\sqrt{3}$) .}
...
%    \includegraphics[width=0.37\textwidth]{./figures/spectral-flow-n-100-w-3-mu-0_0.pdf}%
%  }\\
 %   \subfloat[\label{subfig: spectral-flow-mu-0.0}]{%
 %   \includegraphics[width=0.2\textwidth]{t1.pdf}%
 % }\\
 %   \subfloat[\label{subfig: spectral-flow-mu-0.0}]{%
 %   \includegraphics[width=0.2\textwidth]{./figures/spectral-flow-n-100-w-3-mu-%0_0.pdf}%
 % }\;
%    \subfloat[\label{subfig: spectral-flow-mu-0.0}]{%
%    \includegraphics[width=0.37\textwidth]{t1.pdf}%
%  }\;
...
\begin{figure}[ht]
  \subfloat[\label{subfig: mzm-mu-0.0}]{%
    \includegraphics[width=0.2\textwidth]{sf.pdf}%
  }
  \subfloat[\label{subfig: mzm-mu-0.0}]{%
    \includegraphics[width=0.26\textwidth]{t1.pdf}%
  }\subfloat[\label{subfig: mzm-mu-0.0}]{%
    \includegraphics[width=0.26\textwidth]{t1.pdf}%
  }\subfloat[\label{subfig: mzm-mu-0.0}]{%
    \includegraphics[width=0.26\textwidth]{t1.pdf}%
...
Changing the chemical potential and the vector potential combined makes it possible to ``turn on" one and only one edge of each triangle. During the braiding one must make sure that a vertex is never shared by more than two nontrivial edges.
