...
\begin{figure}[]
  \subfloat[\label{subfig: majorana-number-y-axis}]{%
    \includegraphics[width=0.4\textwidth]{./figures/majorana-number-y-axis.pdf}%
  }\hfill
  \subfloat[\label{subfig: majorana-number-5pi6ths}]{%
    \includegraphics[width=0.4\textwidth]{./figures/majorana-number-5pi6ths.pdf}%
  }\hfill
