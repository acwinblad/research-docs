...
\begin{figure}[ht]
  \subfloat[]{\includegraphics[width=0.0\textwidth]{./triangular-lattice-finite-width-ribbon.pdf}}\\
  \hspace{10pt}
  \begin{tikzpicture}
    \node[inner sep=0pt] (figure) at (0.00,0)
    {\includegraphics[width=0.40\textwidth]{./triangular-lattice-finite-width-ribbon.pdf}} \\

    \node[inner sep=0pt] (a) at (-2.5,1.4) {(a)};
    \node[inner sep=0pt] (A) at (-0.75,1.00) {\small $\vec{A}$};
    \node[inner sep=0pt] (varphi) at (-0.2,-0.05) {\small $\varphi$};
    \node[inner sep=0pt] (x) at (3.7,-1.18) {\small $x$};
    \node[inner sep=0pt] (y) at (0.11,1.45) {\small $y$};
    %\node[inner sep=0pt] (w1) at (-3.3,-1.20) {\small $W=1$};
    %\node[inner sep=0pt] (w2) at (-3.3,-0.40) {\small $W=2$};
    %\node[inner sep=0pt] (w3) at (-3.3,0.40) {\small $W=3$};
    \node[inner sep=0pt] (n1) at (-2.6,-1.50) {\small $n=1$};
    \node[inner sep=0pt] (nL) at (2.8,-1.50) {\small $n=L$};
    \node[inner sep=0pt] (a) at (-1.22,-1.70) {\small $a$};
  \end{tikzpicture}
  \vspace{-15pt}
  \hspace{30pt}
  \subfloat[]{\includegraphics[width=0.355\textwidth]{./topological-phase-diagram-1pi6-w-1.pdf}} \\
  \vspace{-00pt}
...
\begin{figure*}[ht]
  ...
  \subfloat[]{\includegraphics[height=100pt]{./GS-T-Square.pdf}}\hspace{-31.5pt}
  \subfloat[]{\includegraphics[height=100pt]{./GS-T-Triangle.pdf}}\hspace{-31.5pt}
  \subfloat[]{\includegraphics[height=100pt]{./GS-T-Circle.pdf}}\hspace{-31.5pt}
